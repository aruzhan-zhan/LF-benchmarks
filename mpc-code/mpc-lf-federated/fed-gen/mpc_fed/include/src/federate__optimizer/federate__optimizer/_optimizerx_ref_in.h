...
#ifndef __OPTIMIZERX_REF_IN_H // necessary for arduino-cli, which automatically includes headers that are not used
#ifndef TOP_LEVEL_PREAMBLE_285017676_H
#define TOP_LEVEL_PREAMBLE_285017676_H
/*Correspondence: Range: [(20, 0), (85, 1)) -> Range: [(0, 0), (65, 1)) (verbatim=true; src=/home/aruzhanmassalina/REPOS/LF-benchmarks/mpc-code/mpc-lf-federated/fed-gen/mpc_fed/src/federate__optimizer.lf)*/#include <math.h>
#include <string.h>
...
/*Correspondence: Range: [(88, 0), (101, 6)) -> Range: [(0, 0), (13, 6)) (verbatim=true; src=/home/aruzhanmassalina/REPOS/LF-benchmarks/mpc-code/mpc-lf-federated/fed-gen/mpc_fed/src/federate__optimizer.lf)*/#ifdef __cplusplus
extern "C" {
#endif
...
#endif
typedef struct _optimizerx_ref_in_self_t{
    self_base_t base; // This field is only to be used by the runtime, not the user.
    int end[0]; // placeholder; MSVC does not compile empty structs
} _optimizerx_ref_in_self_t;
typedef struct {
    token_type_t type;
    lf_token_t* token;
    size_t length;
