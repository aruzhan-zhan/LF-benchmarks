#ifndef __OPTIMIZERX_REF_IN_H
#define __OPTIMIZERX_REF_IN_H
...
typedef struct {
    ...
    interval_t physical_time_of_arrival;
    #endif
} __optimizerx_ref_in_port_t;
typedef struct {
    struct self_base_t base;
#line 118 "/home/aruzhanmassalina/REPOS/LF-benchmarks/mpc-code/mpc-lf-federated/./fed-gen/mpc_fed/src-gen/federate__optimizer/__optimizerx_ref_in.h"
#line 119 "/home/aruzhanmassalina/REPOS/LF-benchmarks/mpc-code/mpc-lf-federated/./fed-gen/mpc_fed/src-gen/federate__optimizer/__optimizerx_ref_in.h"
    __optimizerx_ref_in_port0_t* _lf_port0;
    // width of -2 indicates that it is not a multiport.
    int _lf_port0_width;
    // Default input (in case it does not get connected)
    __optimizerx_ref_in_port0_t _lf_default__port0;
    // Array of output ports.
    __optimizerx_ref_in_port_t* _lf_port;
    int _lf_port_width;
    ...
    // array of pointers.
    __optimizerx_ref_in_port_t** _lf_port_pointers;
    trigger_t _lf__port0;
    #ifdef FEDERATED
    
    #endif // FEDERATED
} __optimizerx_ref_in_self_t;
__optimizerx_ref_in_self_t* new___optimizerx_ref_in();
#endif // __OPTIMIZERX_REF_IN_H
