...
#include "include/federate__ref/Reference.h"
...
void _referencereaction_function_0(void* instance_args) {
    ...
    #line 116 "/home/aruzhanmassalina/REPOS/LF-benchmarks/mpc-code/mpc-lf-federated/./fed-gen/mpc_fed/src/federate__ref.lf"
    state_t ref = {{0.0, 0.0}};
    lf_set(x_ref, ref);
#line 16 "/home/aruzhanmassalina/REPOS/LF-benchmarks/mpc-code/mpc-lf-federated/./fed-gen/mpc_fed/src-gen/federate__ref/_reference.c"
}
...
void _referencereaction_function_1(void* instance_args) {
    _reference_self_t* self = (_reference_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    _reference_x_ref_t* x_ref = &self->_lf_x_ref;
    #line 122 "/home/aruzhanmassalina/REPOS/LF-benchmarks/mpc-code/mpc-lf-federated/./fed-gen/mpc_fed/src/federate__ref.lf"
    state_t ref = {{1.0, 0.0}};
    lf_set(x_ref, ref);
    printf("[ref    ] reference -> 1.0\n");
#line 27 "/home/aruzhanmassalina/REPOS/LF-benchmarks/mpc-code/mpc-lf-federated/./fed-gen/mpc_fed/src-gen/federate__ref/_reference.c"
}
#include "include/api/reaction_macros_undef.h"
#include "include/api/reaction_macros.h"
void _referencereaction_function_2(void* instance_args) {
    _reference_self_t* self = (_reference_self_t*)instance_args; SUPPRESS_UNUSED_WARNING(self);
    _reference_x_ref_t* x_ref = &self->_lf_x_ref;
    #line 129 "/home/aruzhanmassalina/REPOS/LF-benchmarks/mpc-code/mpc-lf-federated/./fed-gen/mpc_fed/src/federate__ref.lf"
    state_t ref = {{0.5, 0.0}};
    lf_set(x_ref, ref);
    printf("[ref    ] reference -> 0.5\n");
#line 38 "/home/aruzhanmassalina/REPOS/LF-benchmarks/mpc-code/mpc-lf-federated/./fed-gen/mpc_fed/src-gen/federate__ref/_reference.c"
}
#include "include/api/reaction_macros_undef.h"
