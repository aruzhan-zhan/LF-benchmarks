#ifndef __plantu_H
#define __plantu_H
#ifndef __PLANTU_H // necessary for arduino-cli, which automatically includes headers that are not used
#ifndef TOP_LEVEL_PREAMBLE_1175973722_H
#define TOP_LEVEL_PREAMBLE_1175973722_H
/*Correspondence: Range: [(20, 0), (85, 1)) -> Range: [(0, 0), (65, 1)) (verbatim=true; src=/home/aruzhanmassalina/REPOS/LF-benchmarks/mpc-code/mpc-lf-federated/fed-gen/mpc_fed/src/federate__plant.lf)*/#include <math.h>
#include <string.h>
...
/*Correspondence: Range: [(88, 0), (101, 6)) -> Range: [(0, 0), (13, 6)) (verbatim=true; src=/home/aruzhanmassalina/REPOS/LF-benchmarks/mpc-code/mpc-lf-federated/fed-gen/mpc_fed/src/federate__plant.lf)*/#ifdef __cplusplus
extern "C" {
#endif
...
#endif
#endif // TOP_LEVEL_PREAMBLE_1175973722_H
#ifdef __cplusplus
extern "C" {
#endif
